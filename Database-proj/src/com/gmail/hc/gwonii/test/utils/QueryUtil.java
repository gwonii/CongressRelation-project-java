...
public class QueryUtil {
    ...
    public static void queryDistrict(String inputRegion) {
        ...
        try {
            ...
            sql = "select confirm.billCode, billName, region, count(region)\n" +
                    "from ( select congressman.congressManCode, region\n" +
                    "\t  from congressman\n" +
                    "\t  where region like" + "\"%" + inputRegion + "%\"" + ")step, confirm, bill\n" +
                    "where step.congressManCode = confirm.congressManCode\n" +
                    "AND confirm.billCode = bill.billCode\n" +
                    "AND confirm.resultVote = \"찬성\"\n" +
            ...
            while(rs.next()){
                ...
                System.out.println(""+code + "\t|\t"  + region + "\t|\t" + count + "\t|\t"  + name);
            }
    ...
    public static void queryBillList() {
        ...
        try {
            ...
            while(rs.next()){
                ...
                System.out.println(""+code + "\t|\t" + date + "\t|\t" + committeeName + "\t|\t" + name);
            }
